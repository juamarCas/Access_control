...
You can modify the topics and actions of the MQTT service in _./src/MQTT/mqtt.js_. You can find more information in the _mqtt_ library [Documentation](https://www.npmjs.com/package/mqtt "mqtt library documentation")
